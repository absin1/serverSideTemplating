<nav class="navbar navbar-toggleable-md navbar-inverse whitebg fixed-top border_gray p-0 min-h-50">
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav full_width ">
          ...
          <li class="nav-item">
            <a class="nav-link ml-2" href="#">Link</a>
          </li>
          <li class="nav-item">
            <a class="nav-link ml-2 disabled" href="#">Disabled</a>
          </li>
          <li class="nav-item dropdown make-left">
            <a class="nav-link ml-2 dropdown-toggle " href="http://example.com" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Welcome username</a>
